...
| F11-SC-4 single OpenAI provider, no provider registry | `partial` | Attestor-owned OpenAI calls now record response-model drift telemetry. A multi-provider selection/failover registry remains backlog. |
