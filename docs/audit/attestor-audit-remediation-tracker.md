...
| F5 signing layer redo | 21 | 7 | 2 | 12 |
| Final docs / claim alignment | 2 | 0 | 0 | 2 |

Estimated remaining work after this tracker lands: about 14 to 22 PR-sized or
...
1. F5-A3 fingerprint width migration.
2. F5-A4 / F5-A8 canonicalization and numeric payload behavior.
3. F-5.2 / F5-A5 file durability and key persistence atomicity.
4. F5-A7 / F5-NEW-1 keyless CA singleton and test-only injection.
5. F-5.7 / F5-NEW-2 HA shared PKI and production-shared local-PKI closure.
6. F5-NEW-3 legacy unbounded certificate telemetry and sunset.
7. F5-A6 transparency log design decision and claim boundary.
8. F5-B1 crypto-authorization trust-delegation documentation.
9. F1 backlog closure pass for replay correlation, fan-out, and cross-log integrity.
10. Final README/docs/provenance claim alignment.
