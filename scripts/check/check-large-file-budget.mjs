...
const HARD_LIMIT_REGISTRY = Object.freeze([
  ...
  { path: 'src/service/control-plane-store.ts', maxLines: 3784, reason: 'P2 store-family split in progress; schema, PG helpers, and mapper helpers extracted, compatibility facade must keep shrinking.' },
