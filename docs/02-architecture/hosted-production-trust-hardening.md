...
- `src/service/hosted-observability-privacy-incident-evidence.ts` declares the observability profile across privacy-safe request traces/metrics/logs, OTLP receiver boundaries, alert routing context, incident timeline/evidence packets, dashboard runtime truth, and production rehearsal evidence.
