...
const HARD_LIMIT_REGISTRY = Object.freeze([
  ...
  { path: 'src/service/control-plane-store.ts', maxLines: 4583, reason: 'P2 store-family split requires inventory and dedicated store tests before behavior-preserving moves.' },
