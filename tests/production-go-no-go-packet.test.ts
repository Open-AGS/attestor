...
function testDocsAndScriptsExposeStep12(): void {
  ...
  includes(masterPlan, '| Complete | 15 |', 'Unified plan: Step 15 completion count is updated');
  includes(masterPlan, '| Remaining | 11 |', 'Unified plan: remaining count moves to 11');
