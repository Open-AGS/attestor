...
const COVERAGE_PROFILES = {
  ...
  'sensitive-data-disclosure': {
    ...
    testEvidencePaths: [
      ...
      'tests/f6-recipient-tenant-runtime-boundary.test.ts',
    ],
    docEvidencePaths: [
      'docs/02-architecture/data-minimization-redaction-policy.md',
      'docs/02-architecture/recipient-tenant-boundary-replay.md',
    ],
    notProven: COMMON_NOT_PROVEN,
    limitation:
  ...
  'cross-tenant-leakage': {
    ...
    dedicatedGuardPresent: false,
    customerIntegrationRequired: true,
    primaryImplementationPath: 'src/consequence-admission/recipient-tenant-boundary-runtime.ts',
    codeEvidencePaths: [
      'src/consequence-admission/recipient-tenant-boundary-runtime.ts',
    ...
    notProven: COMMON_NOT_PROVEN,
    limitation:
      'Runtime boundary bridge renders tenant decisions from supplied metadata, but every route, store, dashboard, and export surface must still integrate and enforce it.',
  },
  'wrong-recipient-disclosure': {
    ...
    notProven: COMMON_NOT_PROVEN,
    limitation:
      'Runtime boundary bridge renders recipient decisions from supplied metadata, but downstream senders must still integrate and enforce it before delivery.',
  },
