...
function testDocsAndScriptsExposeStep12(): void {
  ...
  includes(masterPlan, '| Complete | 22 |', 'Unified plan: Step 22 completion count is updated');
  includes(masterPlan, '| Remaining | 4 |', 'Unified plan: remaining count moves to 4');
