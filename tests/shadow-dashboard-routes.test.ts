import {
  ...
  ok,
  passedCount,
  testDashboardRoutesRejectForeignTenantEvents,
  testDashboardRoutesRejectMissingTenantEvents,
} from './shadow-dashboard-routes-fixtures.js';
...
console.log(`Shadow dashboard route tests: ${passedCount()} passed, 0 failed`);
