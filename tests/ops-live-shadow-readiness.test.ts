...
function main(): void {
  const liveShadowProofs = [
    ...
    'ATTESTOR_ACCOUNT_MUTATION_IDEMPOTENCY_PROOF',
    'ATTESTOR_SHARED_AUTH_ABUSE_STORE_PROOF',
    'ATTESTOR_PIPELINE_IDEMPOTENCY_PROOF',
    'ATTESTOR_SHADOW_MUTATION_AUDIT_CHAIN_PROOF',
    'ATTESTOR_SHADOW_MUTATION_RATE_LIMIT_PROOF',
    'ATTESTOR_SHADOW_MUTATION_IDEMPOTENCY_PROOF',
    'ATTESTOR_RELEASE_ROUTE_ROLE_ENFORCEMENT_PROOF',
    'ATTESTOR_HEALTH_DIAGNOSTIC_SPLIT_PROOF',
    'ATTESTOR_VERIFY_RATE_LIMIT_PROOF',
    'ATTESTOR_CORS_CSRF_DEPLOYMENT_PROOF',
    'ATTESTOR_CONSEQUENCE_RETRY_ATTEMPT_LEDGER_PROOF',
    'ATTESTOR_BRANCH_PROTECTION_SIGNATURES_PROOF',
    'ATTESTOR_BRANCH_PROTECTION_REVIEWS_PROOF',
