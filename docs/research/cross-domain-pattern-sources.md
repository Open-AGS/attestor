...
| Authority-creep guard | [Goodhart variants](https://arxiv.org/abs/1803.04585), [NIST AI RMF](https://www.nist.gov/itl/ai-risk-management-framework), [Google SRE Embracing Risk](https://sre.google/sre-book/embracing-risk/), [Google SRE Service Level Objectives](https://sre.google/sre-book/service-level-objectives/), [CISA SSVC](https://www.cisa.gov/stakeholder-specific-vulnerability-categorization-ssvc), [SRI Assurance 2.0](https://www.csl.sri.com/users/rushby/assurance2.0), [CMU SEI Eliminative Argumentation](https://www.sei.cmu.edu/library/eliminative-argumentation-a-basis-for-arguing-confidence-in-system-properties/) | Treat measurement, calibration, budget, and lineage material as evidence or defeat only; if it starts acting like authority, open an undercutting defeater. | Authority-Creep Guard. | No policy activation, no measurement authority, no lineage mutation, no defeater closure, no review decision, no live enforcement, and no production readiness claim. |
| Outcome feedback / COE wiring | [AWS Correction of Error](https://aws.amazon.com/blogs/mt/why-you-should-develop-a-correction-of-error-coe/), [Google SRE Postmortem Culture](https://sre.google/sre-book/postmortem-culture/), [NIST SP 800-61 Rev. 3](https://csrc.nist.gov/pubs/sp/800/61/r3/final), [NIST AI RMF Core](https://airc.nist.gov/airmf-resources/airmf/5-sec-core/), [MIT STPA Handbook](http://psas.scripts.mit.edu/home/get_file.php?name=STPA_handbook.pdf), [CMU SEI Eliminative Argumentation](https://www.sei.cmu.edu/library/eliminative-argumentation-a-basis-for-arguing-confidence-in-system-properties/) | Treat post-outcome receipts, incidents, postmortems, and COE material as digest-bound evidence or rebutting defeat, with action items visible and no silent mutation path. | Outcome Feedback / COE Wiring. | No COE conformance, no postmortem system, no reviewer decision, no policy activation, no model training, no live enforcement, and no production readiness claim. |
...
23. Measurement, budget, calibration, and lineage artifacts must not become authority; if they support a claim or request policy relaxation, score calibration, model training, enforcement activation, or other authority action, the system should open undercutting defeat.
24. Negative outcome feedback should open rebutting defeat, and COE/postmortem material should remain digest-bound action-item evidence rather than becoming silent policy or model mutation.
...
| Authority-creep guard | Converts I11 lineage and optional measurement-plane material into evidence or open undercutting defeaters when metrics, budget, calibration, lineage, or measurement outputs begin acting like authority. |
| Outcome feedback / COE wiring | Converts I00 assurance-case material and outcome feedback into post-outcome evidence or open rebutting defeaters while keeping COE/postmortem action items digest-bound and non-authoritative. |
...
20. authority-creep guard for Runtime Intelligence Activation v1
21. outcome feedback / COE wiring for Runtime Intelligence Activation v1
```
