...
function testMasterPlanRecordsResearchAnchorsAndNonClaims(): void {
  ...
  for (const expected of [
    ...
    'Okta Workflows Okta connector',
    'Microsoft Entra ID Governance',
    'SailPoint workflow triggers',
  ...
  includes(plan, 'live customer pilot execution', 'Unified plan: live pilot non-claim is explicit');
  assert.equal(
