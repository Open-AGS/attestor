...
- The machine-readable domain-pack boundary is exported from `attestor/consequence-admission`. It keeps pack-specific defaults, evidence shapes, adapters, readiness signals, and replay examples below the shared decision vocabulary, failure registry, control bindings, and replay layer.
