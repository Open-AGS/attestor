...
const runtimeSecretMappings: SecretMapping[] = [
  ...
  { envName: 'ATTESTOR_STRIPE_PRICE_PILOT_WORKFLOW', secretKey: 'stripe-price-pilot-workflow', remoteSuffix: 'stripe-price-pilot-workflow' },
  { envName: 'ATTESTOR_STRIPE_PRICE_STARTER_WORKFLOW', secretKey: 'stripe-price-starter-workflow', remoteSuffix: 'stripe-price-starter-workflow' },
  { envName: 'ATTESTOR_STRIPE_PRICE_PRO_WORKFLOW', secretKey: 'stripe-price-pro-workflow', remoteSuffix: 'stripe-price-pro-workflow' },
  { envName: 'ATTESTOR_STRIPE_OVERAGE_PRICE_STARTER_WORKFLOW', secretKey: 'stripe-overage-price-starter-workflow', remoteSuffix: 'stripe-overage-price-starter-workflow' },
  { envName: 'ATTESTOR_STRIPE_OVERAGE_PRICE_PRO_WORKFLOW', secretKey: 'stripe-overage-price-pro-workflow', remoteSuffix: 'stripe-overage-price-pro-workflow' },
