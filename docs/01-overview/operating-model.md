...
Use this page as the customer-facing truth source for how Attestor is used as an AI Action Control Plane with consequence admission and enforcement points.
...
Externally, Attestor is the AI Action Control Plane for high-risk AI actions. Operationally, it uses consequence admission to decide whether the proposed action may proceed, must be narrowed, needs review, or must be blocked.
