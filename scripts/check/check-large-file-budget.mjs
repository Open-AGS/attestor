...
const HARD_LIMIT_REGISTRY = Object.freeze([
  ...
  { path: 'src/service/control-plane-store.ts', maxLines: 3628, reason: 'P2 store-family split in progress; schema, PG helpers, mapper helpers, and pipeline idempotency state extracted; compatibility facade must keep shrinking.' },
