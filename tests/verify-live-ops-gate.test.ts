...
function testExternalLiveCannotJoinByAccident(): void {
  ...
  excludes(fullWithoutExternal, 'probe:anthropic-live-smoke', 'Live/ops gate: full mode excludes Anthropic live smoke without external gate');
  ...
  includes(fullWithExternal, 'probe:anthropic-live-smoke', 'Live/ops gate: full mode can include Anthropic live smoke when explicitly enabled');
  ...
  includes(externalWithGate, 'probe:anthropic-live-smoke', 'Live/ops gate: external mode includes Anthropic live smoke when opted in');
}
...
function testPackageAndWorkflowExposeBoundaries(): void {
  ...
  includes(productionReadiness, 'Anthropic live smoke', 'Live/ops gate: production docs mention Anthropic live smoke boundary');
}
