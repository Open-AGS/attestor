...
function testReleaseNotesAreLinkedAndBounded(): void {
  ...
  includes(readme, 'Release tag:     v0.3.0-evaluation', 'Evaluation release: README names the evaluation release tag');
  ...
  includes(notes, '**Release tag:** `v0.3.0-evaluation`', 'Evaluation release: tag state is explicit');
