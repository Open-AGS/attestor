...
function testDocsAndScriptsExposeStep12(): void {
  ...
  includes(masterPlan, '| Complete | 26 |', 'Unified plan: Step 23 completion count is updated');
  includes(masterPlan, '| Remaining | 0 |', 'Unified plan: remaining count moves to 3');
