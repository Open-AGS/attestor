...
import {
  ...
  CONSEQUENCE_FAILURE_MODE_REGISTRY_PLACEMENT_SOURCE_FILES,
  ...
  type ConsequenceFailureModeRegistry,
  type ConsequenceFailureModeRegistryEntry,
  type ConsequenceFailureModeRegistryPlacementDescriptor,
  type ConsequenceFailureModeRepositoryEvidenceRef,
  type ConsequenceFailureModeSourceRef,
} from './failure-mode-registry-types.js';
...
export {
  ...
  CONSEQUENCE_FAILURE_MODE_REGISTRY_VERSION,
  CONSEQUENCE_FAILURE_MODE_SEVERITIES,
  CONSEQUENCE_FAILURE_MODE_SOURCE_IDS,
} from './failure-mode-registry-types.js';
export type {
  ConsequenceFailureModeClassification,
  ConsequenceFailureModeDefaultDecision,
  ConsequenceFailureModeId,
  ConsequenceFailureModeProtectedPrinciple,
  ConsequenceFailureModeRegistry,
  ConsequenceFailureModeRegistryEntry,
  ConsequenceFailureModeRegistryOwningRole,
  ConsequenceFailureModeRegistryPlacementDescriptor,
  ConsequenceFailureModeRegistryPlacementSourceFile,
  ConsequenceFailureModeRepositoryEvidenceRef,
  ConsequenceFailureModeSeverity,
  ConsequenceFailureModeSourceId,
  ConsequenceFailureModeSourceRef,
} from './failure-mode-registry-types.js';
...
Object.freeze([
  ...
  entry({
    ...
    requiredControls: [
      ...
      'aggregate-reviewer-behavior-telemetry',
    ],
    defaultDecision: 'review',
    repositoryEvidence: [
      ...
      evidence('test', 'tests/human-review-fatigue-guard.test.ts', 'no-go, missing-evidence, noise, reviewer-behavior, and raw-payload fatigue checks'),
      evidence('test', 'tests/policy-foundry-hosted-review-surface.test.ts', 'no-go cards and evidence digest cards'),
    ],
    limitation: 'Review fatigue scoring is deterministic for packet quality and aggregate behavior signals; live reviewer workload calibration still needs customer environment telemetry.',
  }),
  entry({
