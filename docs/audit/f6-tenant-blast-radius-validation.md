...
2. Tenant-bound release-token/admission semantics for F6-T1/F6-T6. Done for token semantics, tenant signer boundary contract, and structured live-proof gate; live per-tenant signer isolation remains partial until a real provider adapter is wired.
