...
| [Golden Path: Programmable Money](docs/02-architecture/golden-programmable-money-shadow-pilot.md) | Programmable Money | `npm run test:golden-programmable-money-policy-foundry-projection` | A synthetic, shadow-only P01/P02 contract for Safe transactions, wallet calls, account abstraction, x402 payments, custody callbacks, intent settlement, and review-only Policy Foundry projection. It does not sign, broadcast, call a wallet, activate enforcement, or prove chain settlement. |
