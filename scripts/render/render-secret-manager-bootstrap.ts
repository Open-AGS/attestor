...
function buildCatalog(prefix: string, provider: ConcreteProvider): SecretCatalogEntry[] {
  return [
    ...
    {
      logicalName: `${prefix}/stripe-price-pilot-workflow`,
      remoteName: remoteSecretKey(provider, `${prefix}/stripe-price-pilot-workflow`),
      type: 'string',
      required: true,
      consumer: 'ha',
      env: 'ATTESTOR_STRIPE_PRICE_PILOT_WORKFLOW',
    },
    {
      logicalName: `${prefix}/stripe-price-starter-workflow`,
      remoteName: remoteSecretKey(provider, `${prefix}/stripe-price-starter-workflow`),
      type: 'string',
      required: true,
      consumer: 'ha',
      env: 'ATTESTOR_STRIPE_PRICE_STARTER_WORKFLOW',
    },
    {
      logicalName: `${prefix}/stripe-price-pro-workflow`,
      remoteName: remoteSecretKey(provider, `${prefix}/stripe-price-pro-workflow`),
      type: 'string',
      required: true,
      consumer: 'ha',
      env: 'ATTESTOR_STRIPE_PRICE_PRO_WORKFLOW',
    },
    {
      logicalName: `${prefix}/stripe-overage-price-starter-workflow`,
      remoteName: remoteSecretKey(provider, `${prefix}/stripe-overage-price-starter-workflow`),
      type: 'string',
      required: true,
      consumer: 'ha',
      env: 'ATTESTOR_STRIPE_OVERAGE_PRICE_STARTER_WORKFLOW',
    },
    {
      logicalName: `${prefix}/stripe-overage-price-pro-workflow`,
      remoteName: remoteSecretKey(provider, `${prefix}/stripe-overage-price-pro-workflow`),
      type: 'string',
      required: true,
      consumer: 'ha',
      env: 'ATTESTOR_STRIPE_OVERAGE_PRICE_PRO_WORKFLOW',
    },
    {
