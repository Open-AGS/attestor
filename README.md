...
Attestor turns an AI-prepared action into a bounded decision:
...
Attestor moves the control point to that moment.
...
Attestor is built around proof before action.
...
This does not automatically prove external facts, third-party immutability, production signing authority, or live customer deployment.

Run the local proof surface:
...
- a payment processor
- a downstream system of record
- a permission slip for AI actions without customer-side enforcement
- proof that this evaluation release is production-ready
- a substitute for external security audit, compliance certification, or customer deployment review
...
- [Commercial packaging and evaluation](docs/01-overview/product-packaging.md)
