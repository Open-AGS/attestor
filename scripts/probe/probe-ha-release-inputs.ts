...
export async function probeHaReleaseInputs(options?: {
  ...
  if (publicHostname) {
    ...
    required('ATTESTOR_STRIPE_PRICE_PILOT_WORKFLOW', env('ATTESTOR_STRIPE_PRICE_PILOT_WORKFLOW'), issues);
    required('ATTESTOR_STRIPE_PRICE_STARTER_WORKFLOW', env('ATTESTOR_STRIPE_PRICE_STARTER_WORKFLOW'), issues);
    required('ATTESTOR_STRIPE_PRICE_PRO_WORKFLOW', env('ATTESTOR_STRIPE_PRICE_PRO_WORKFLOW'), issues);
    required('ATTESTOR_STRIPE_OVERAGE_PRICE_STARTER_WORKFLOW', env('ATTESTOR_STRIPE_OVERAGE_PRICE_STARTER_WORKFLOW'), issues);
    required('ATTESTOR_STRIPE_OVERAGE_PRICE_PRO_WORKFLOW', env('ATTESTOR_STRIPE_OVERAGE_PRICE_PRO_WORKFLOW'), issues);
