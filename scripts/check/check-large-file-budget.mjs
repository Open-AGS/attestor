...
const HARD_LIMIT_REGISTRY = Object.freeze([
  ...
  { path: 'src/service/control-plane-store.ts', maxLines: 4187, reason: 'P2 store-family split in progress; schema and PG helpers extracted, compatibility facade must keep shrinking.' },
