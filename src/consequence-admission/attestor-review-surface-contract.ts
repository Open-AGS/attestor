...
import {
  ...
  ATTESTOR_REVIEW_SURFACE_PROHIBITED_RAW_CLASSES,
  ATTESTOR_REVIEW_SURFACE_REQUIRED_FIELDS,
  ATTESTOR_REVIEW_SURFACE_SOURCE_SURFACES,
  ATTESTOR_REVIEW_SURFACE_STATUS_LABELS,
  ATTESTOR_REVIEW_SURFACE_VERSION,
} from './attestor-review-surface-types.js';
import type {
  ...
  AttestorReviewSurfaceDecisionPosture,
  ...
  AttestorReviewSurfaceSourceSurface,
  AttestorReviewSurfaceStatusLabel,
  AttestorReviewSurfaceTimeWindow,
  CreateAttestorReviewCaseDetailInput,
  CreateAttestorReviewSurfaceInput,
...
export type {
  ...
  AssuranceHealthPanel,
  AttestorReviewSurface,
  AttestorReviewSurfaceArea,
  AttestorReviewSurfaceAuthorityBoundary,
  AttestorReviewSurfaceCommon,
  AttestorReviewSurfaceContractDescriptor,
  AttestorReviewSurfaceContractSlice,
  AttestorReviewSurfaceDataForm,
  AttestorReviewSurfaceDecisionPosture,
  AttestorReviewSurfaceEvidenceState,
  AttestorReviewSurfaceFreshness,
  AttestorReviewSurfaceFreshnessState,
  AttestorReviewSurfaceLifecycleState,
  AttestorReviewSurfaceMode,
  AttestorReviewSurfaceProhibitedRawClass,
  AttestorReviewSurfaceRequiredField,
  AttestorReviewSurfaceSourceSurface,
  AttestorReviewSurfaceStatusLabel,
  AttestorReviewSurfaceTimeWindow,
  CreateAttestorReviewCaseDetailInput,
