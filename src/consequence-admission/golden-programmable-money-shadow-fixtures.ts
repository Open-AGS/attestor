...
import {
  GOLDEN_PROGRAMMABLE_MONEY_SHADOW_FIXTURE_NON_CLAIMS,
  ...
  type GoldenProgrammableMoneyShadowFixtureOperationFacts,
  type GoldenProgrammableMoneyShadowFixturePosture,
  type GoldenProgrammableMoneyShadowFixtureScenario,
  type GoldenProgrammableMoneyShadowFixtureSuite,
  type GoldenProgrammableMoneyShadowFixturesDescriptor,
} from './golden-programmable-money-shadow-fixtures-types.js';

export {
  GOLDEN_PROGRAMMABLE_MONEY_SHADOW_FIXTURE_NON_CLAIMS,
  GOLDEN_PROGRAMMABLE_MONEY_SHADOW_FIXTURE_POSTURES,
  GOLDEN_PROGRAMMABLE_MONEY_SHADOW_FIXTURE_SCENARIOS,
  GOLDEN_PROGRAMMABLE_MONEY_SHADOW_FIXTURES_VERSION,
} from './golden-programmable-money-shadow-fixtures-types.js';
export type {
  ...
  GoldenProgrammableMoneyShadowFixtureScenario,
