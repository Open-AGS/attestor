...
import {
  EXPECTED,
  RAW_NARROW_CONSTRAINT_ID,
  RAW_NARROW_CONSTRAINT_SUMMARY,
  admittedPayment,
  admittedPaymentWithReceiptAndReleaseToken,
  deepEqual,
  digestText,
  equal,
  includes,
  ...
  receiptOnlyPayment,
  throws,
} from './downstream-presentation-binding-fixtures.js';
...
console.log(`Downstream presentation binding tests: ${passedCount()} passed, 0 failed`);
