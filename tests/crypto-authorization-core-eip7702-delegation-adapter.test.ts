...
import {
  ...
  testDescriptor,
  throws,
} from './crypto-authorization-core-eip7702-delegation-adapter-fixtures.js';
...
console.log(`crypto-authorization-core-eip7702-delegation-adapter: ${passedCount()} checks passed`);
