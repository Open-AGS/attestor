...
async function main(): Promise<void> {
  ...
  try {
    ...
    process.env.ATTESTOR_API_IMAGE = `ghcr.io/example/attestor-api@sha256:${'a'.repeat(64)}`;
    process.env.ATTESTOR_WORKER_IMAGE = `ghcr.io/example/attestor-worker@sha256:${'b'.repeat(64)}`;
    ...
    process.env.ATTESTOR_RELEASE_RUNTIME_PKI_STORAGE_CLASS = 'attestor-release-runtime-pki-rwx';
    ...
    process.env.ATTESTOR_STRIPE_PRICE_PILOT_WORKFLOW = 'price_pilot_workflow_readiness';
    process.env.ATTESTOR_STRIPE_PRICE_STARTER_WORKFLOW = 'price_starter_workflow_readiness';
    process.env.ATTESTOR_STRIPE_PRICE_PRO_WORKFLOW = 'price_pro_workflow_readiness';
    process.env.ATTESTOR_STRIPE_OVERAGE_PRICE_STARTER_WORKFLOW = 'price_starter_workflow_overage_readiness';
    process.env.ATTESTOR_STRIPE_OVERAGE_PRICE_PRO_WORKFLOW = 'price_pro_workflow_overage_readiness';
