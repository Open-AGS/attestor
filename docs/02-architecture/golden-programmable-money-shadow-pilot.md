...
| P04 demo CLI | `src/consequence-admission/golden-programmable-money-demo.ts` and `scripts/demo/demo-golden-programmable-money.ts` compose P01-P03 evidence into Markdown-first local demo output and JSON as secondary machine output. | repo-proven once merged |
